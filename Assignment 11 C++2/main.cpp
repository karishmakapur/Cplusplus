...
int main() {
	...
	//assignment10
	m->addMenuItem("29. Assignment 11", assignment11);
...
void assignment11()
{
	...
	Integer n;
	cout << " n = " << n.data() << " " << n.getNan() << endl;
	Integer p("5");
	cout << " p = " << p.data() << " " << p.getNan() << endl;
	Integer q("3");
	cout << " q = " << q.data() << " " << q.getNan() << endl;
	Integer d("4.5");
	cout << " d = " << d.data() << " " << d.getNan() << endl;
	Integer o("p");
	cout << " o = " << o.data() << " " << o.getNan() << endl;
	Integer c = q + p;
	cout << " c = q + p = " << c.data() << " " << c.getNan() << endl;
	Integer e = p - q;
	cout << " e = p - q = " << e.data() << " " << e.getNan() << endl;
	Integer r = q * p;
	cout << " r = q * p = " << r.data() << " " << r.getNan() << endl;
	Integer t = p / q;
	cout << " t = p / q = " << t.data() << " " << t.getNan() << endl;
	int y = 9;
	Integer z = 16;
	Integer k = z + y;
	cout << " k = z + y = " << k.data() << " " << k.getNan() << endl;
	k = z - y;
	cout << " k = z - y = " << k.data() << " " << k.getNan() << endl;
	k = z * y;
	cout << " k = z * y = " << k.data() << " " << k.getNan() << endl;
	...
	cout << " k = z / y = " << k.data() << " " << k.getNan() << endl;
	Integer i(q);
	cout << " i = " << i.data() << " " << i.getNan() << endl;
	i = "51";
	cout << " i = " << i.data() << " " << i.getNan() << endl;
	cout << " q = " << q.data() << " " << q.getNan() << endl;
	Integer a(5);
	cout << " a = " << a.data() << " " << a.getNan() << endl;
	Integer u(923.5);
	cout << " u = " << u.data() << " " << u.getNan() << endl;
	Integer x = 623;
	cout << " x = " << x.data() << " " << x.getNan() << endl;

	cout << "===========Testing for all functionality of Double class============" << endl;
	Double n1;
	cout << " n1 = " << n1.data() << " " << n1.getNan() << endl;
	Double p1("5..0");
	cout << " p1 = " << p1.data() << " " << p1.getNan() << endl;
	Double q1("3");
	cout << " q1 = " << q1.data() << " " << q1.getNan() << endl;
	Double d1("4.5");
	cout << " d1 = " << d1.data() << " " << d1.getNan() << endl;
	Double o1("p");
	cout << " o1 = " << o1.data() << " " << o1.getNan() << endl;
	Double c1 = d1 + q1;
	cout << " c1 = d1 + q1 = " << c1.data() << " " << c1.getNan() << endl;
	Double e1 = d1 - q1;
	cout << " e1 = d1 - q1 = " << e1.data() << " " << e1.getNan() << endl;
	Double r1 = d1 * q1;
	cout << " r1 = d1 * q1 = " << r1.data() << " " << r1.getNan() << endl;
	Double t1 = d1 / q1;
	cout << " t1 = d1 / q1 = " << t1.data() << " " << t1.getNan() << endl;
	double y1 = 9.7;
	Double z1 = 16.6;
	Double k1 = z1 + y1;
	cout << " k1 = z1 + y1 = " << k1.data() << " " << k1.getNan() << endl;
	k1 = z1 - y1;
	cout << " k1 = z1 - y1 = " << k1.data() << " " << k1.getNan() << endl;
	k1 = z1 * y1;
	cout << " k1 = z1 * y1 = " << k1.data() << " " << k1.getNan() << endl;
	...
	cout << " k1 = z1 / y1 = " << k1.data() << " " << k1.getNan() << endl;
	Double i1(q1);
	cout << " i1 = " << i1.data() << " " << i1.getNan() << endl;
	i1 = "51.0.8.";
	cout << " i1 = " << i1.data() << " " << i1.getNan() << endl;
	cout << " q1 = " << q1.data() << " " << q1.getNan() << endl;
	Double a1(5);
	cout << " a1 = " << a1.data() << " " << a1.getNan() << endl;
	Double u1(923.5);
	cout << " u1 = " << u1.data() << " " << u1.getNan() << endl;
	Double x1 = 34.56;
	cout << " x1 = " << x1.data() << " " << x1.getNan() << endl;
	m->waitKey();
}
