...
void caseOne()
{
	...
	cout << 1 << ".  Check if Empty and report the result" << endl;
	if (L.isEmpty())
	{
	...
	cout << 3 << ".  Add 4 integers (1,2,3,4) to the rear" << endl;
	L.addRear(1);
	L.addRear(2);
	L.addRear(3);
	L.addRear(4);
	...
	cout << 5 << ".  Remove from Front twice and display elements removed." << endl;
	L.deleteFront(x);
	cout << "Deleted " << x << endl;
	L.deleteFront(x);
	cout << "Deleted " << x << endl;
	...
	cout << 7 << ".  Check if empty and report result." << endl;
	if (L.isEmpty())
	{
		cout << "The list is empty." << endl;
	}
	...
	cout << 8 << ".  Remove from Rear twice and display the elements removed. " << endl;
	L.deleteRear(x);
	cout << "Deleted " << x << endl;
	L.deleteRear(x);
	cout << "Deleted " << x << endl;
	...
	cout << 9 << ".  Check if empty and report result." << endl;
	if (L.isEmpty())
	{
		cout << "The list is empty." << endl;
	}
...
void caseTwo()
{
	...
	cout << c << ".  Add to front (Element 5)" << endl; 
	c++;
	L2.addFront(5);

	// 2.add to front again  (element 4)
	cout << c << ".  Add to front (Element 4)" << endl; 
	c++;
	L2.addFront(4);

	// 3.delete Front
	cout << c << ".  Delete from front" << endl; 
	c++;
	L2.deleteFront(x);
	cout << "Deleted " << x << endl;

	// 4.add to rear 3 times (elements 6,8,9)
	cout << c << ".  Add 6,8, and 9 to the rear." << endl; 
	c++;
	L2.addRear(6);
	L2.addRear(8);
	L2.addRear(9);
	...
	cout << c << ".  Add before the 1st element (Element 4)" << endl;
	c++;
	L2.addbeforeIth(1, 4);
	L2.displayAll();

	// 7.add before the 4th  (element 7) . 4 5 6 7 8 9
	cout << c << ".  Add before the 4th element. (Element 7)" << endl; 
	c++;
	L2.addbeforeIth(4, 7);
	L2.displayAll();

	// 8.add before the 7th  (element 10) . 4 5 6 7 8 9 10
	cout << c << ".  Add before the 7th element. (Element 10)" << endl; 
	c++;
	L2.addbeforeIth(7, 10);
	L2.displayAll();

	// 9.add before the 9th  (element 12) . error (out of range)
	cout << c << ".  Add before the 9th element. (Element 12)" << endl; 
	c++;
	try 
	{
	...
	cout << c << ".  Add before the 0th element. (Element 0)" << endl; 
	c++;
	try 
	{ 
		L2.addbeforeIth(0, 0); 
	...
	cout << c << ".  Delete the Ith (I == 1) element" << endl; 
	c++;
	L2.deleteIth(1, x);
	cout << "Deleted " << x << endl;

	// 13.delete Ith I==6 (indicate the element removed)  - 5 6 7 8 9 
	cout << c << ".  Delete the Ith (I == 6) element" << endl; 
	c++;
	L2.deleteIth(6, x);
	cout << "Deleted " << x << endl;
	
	// 14.delete Ith I==3 (indicate the element removed)  - 5 6 8 9
	cout << c << ".  Delete the Ith (I == 3) element" << endl;
	c++;
	L2.deleteIth(3, x);
	cout << "Deleted " << x << endl;

	// 15.delete Ith I==5 . error (out of range)
	cout << c << ".  Delete the Ith (I == 5) element" << endl;
	c++;
	try 
	{
		L2.deleteIth(5, x);
	...
	cout << c << ".  Delete the Ith (I == 0) element" << endl;
	c++;
	try
	{
		L2.deleteIth(0, x);
	...
	cout << c << ".  Delete from rear until empty" << endl; 
	c++;
	while (!L2.isEmpty())
	{
		L2.deleteRear(x);
...
void caseThree()
{
	...
	cout << 1 << ".  Add before the 0th element (Element 0)" << endl;;
	try 
	{
		L3.addbeforeIth(0, 0);
	}
	...
	cout << 2 << ".  Delete front element" << endl;
	try 
	{
		L3.deleteFront(x);
	}
	...
	{
		cerr << "Error has occured: Under flow" << endl;
	}
...
void caseFour()
{
	...
	cout << 2 << ".  Delete rear element" << endl;
	try 
	{ 
		L4.deleteRear(x); 
	}
...
//PURPOSE of the Program: test the functions to make sure they are working.
//Algorithm/Design: 4 test cases are divided into 4 functions and check all possible error cases, 
//as well as any possible cases that can be done with the class methods from llist.cpp
int main()
{
