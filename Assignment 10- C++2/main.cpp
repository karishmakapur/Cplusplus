...
int main() {
	//I have made a function in Integer.cpp and Double.cpp that prints the values of 
	//the string, nan, and the variable value.
	...
	//assignment10
	m->addMenuItem("29. Assignment 10", assignment10);
...
void assignment10()
{
	Menu *m = Menu::Instance();
	cout << "=========Doubles============" << endl;
	//created different scopes so that the memory would be created and released within the scope.
	{
		Double d("1..234");
		d.assignment10PrintFunc("1..234");
	}
	{
		Double d(".23.x4");
		d.assignment10PrintFunc(".23.x4");
	}
	{
		Double d("2.x34 ");
		d.assignment10PrintFunc("2.x34 ");
	}

	{
		Double d("234");
		d.assignment10PrintFunc("234");
	}
	{
		Double d("2.34");
		d.assignment10PrintFunc("2.34");
	}

	{
		Double d("2x.34");
		d.assignment10PrintFunc("2x.34");
	}
	{
		Double d("20.34x");
		d.assignment10PrintFunc("20.34x");
	}
	{
		Double d("0.234x");
		d.assignment10PrintFunc("0.234x");
	}
	{
		Double d("...234x");
		d.assignment10PrintFunc("..234x");
	}
	{
		Double d("0.3.4");
		d.assignment10PrintFunc("0.3.4");
	}
	{
		Double d("234 x");
		d.assignment10PrintFunc("234 x");
	}
	{
		Double d("234");
		d.assignment10PrintFunc("234");
	...
	{
		Double d("0.234");
		d.assignment10PrintFunc("0.234");
	}
	cout << "================Integers=================" << endl;
	{
		Integer i("x123");
		i.assignment10PrintFunc("x123");
	}
	{
		Integer i("12x3");
		i.assignment10PrintFunc("12x3");
	}
	{
		Integer i("123x");
		i.assignment10PrintFunc("123x");
	}
	{
		Integer i("1 2 3 x");
		i.assignment10PrintFunc("1 2 3 x");
	}
	{
		Integer i("    1");
		i.assignment10PrintFunc("    1");
	}
	{
		Integer i(" 1 ");
		i.assignment10PrintFunc(" 1 ");
	...
	{
		Integer i("0123");
		i.assignment10PrintFunc("0123");
	}
	{
		Integer i("1203");
		i.assignment10PrintFunc("1203");
	}
	{
		Integer i("120300");
		i.assignment10PrintFunc("120300");
	}
	{
		Integer i("1.23");
		i.assignment10PrintFunc("1.23");
	}
	{
		Integer i("0.123");
		i.assignment10PrintFunc("0.123");
	}
	{
		Integer i("1.23x");
		i.assignment10PrintFunc("1.23x");
	}
	{
		Integer i("123 ");
		i.assignment10PrintFunc("123 ");
	}
	{
		Integer i(" 123");
		i.assignment10PrintFunc(" 123");
